...
class SearchCategoriesScreen extends StatefulWidget {
  @override
  _SearchCategoriesScreenState createState() => _SearchCategoriesScreenState();
}
...
class _SearchCategoriesScreenState extends State<SearchCategoriesScreen> {
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return CategoryWidget(
                  category: value.searchResult.elementAt(index),
                );
              },
  ...
  @override
  void dispose() {
    Provider.of<CategoriesProvider>(context, listen: false).searchClear();
    super.dispose();
  }
}
